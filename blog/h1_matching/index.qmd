...
::: {.callout-note}
**Interpretation – LLN**:  
As the number of simulated draws increases, the cumulative average difference between the treatment and control groups stabilizes around the true value (0.004). This confirms the Law of Large Numbers — with large enough samples, empirical means converge to theoretical expectations.
:::
