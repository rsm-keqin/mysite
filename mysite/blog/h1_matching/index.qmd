...
This dataset was provided by Karlan and List (2007) and contains information on over 50,000 individuals who received a direct mail fundraising letter. The variables describe the treatment they were assigned, their prior donation behavior, and their demographic or regional context.

```{python}
import pandas as pd
import pyreadstat

df, meta = pyreadstat.read_dta("Week1/karlan_list_2007.dta")
